...
export default function GolfCartsPage() {
  ...
  return (
    <div className="bg-base-light text-base-dark min-h-screen pt-28 pb-28">
      ...
      {/* Header Section */}
      <div className="w-full pl-6 pr-4 md:pl-12 md:pr-6 lg:pl-16 lg:pr-8 mb-8">
        <Link
          href="/villas"
          className="inline-flex items-center space-x-2 text-sm font-sans font-bold tracking-wider uppercase text-ocean-teal hover:text-sand-accent transition-colors mb-4"
        >
          <span>←</span>
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-5 lg:-mt-12">
            <div>
              <h1 className="text-4xl md:text-5xl font-sans font-light tracking-tight text-base-dark leading-none mb-2">
                4 Seater Golfcart
              </h1>
            ...
            <div className="bg-white border border-sand-accent/15 rounded-3xl p-5 shadow-sm space-y-2">
              <h3 className="font-sans font-bold uppercase tracking-widest text-[10px] text-ocean-teal">Rental Rates</h3>
              
              <div className="flex flex-col">
                <div className="flex items-baseline gap-2">
                  <span className="font-serif italic text-4xl text-base-dark">$900 - $1,100</span>
      ...
      {/* Grid Image Gallery */}
      <div className="max-w-7xl mx-auto px-6 mb-16">
        <h2 className="font-serif italic text-3xl md:text-4xl text-base-dark mb-8 text-center">Cart Gallery & Details</h2>
      ...
      {cartData.houseRules && (
        <div className="max-w-7xl mx-auto px-6">
          <section className="space-y-6 pt-12 border-t border-sand-accent/10">
            <h3 className="font-serif italic text-3xl text-base-dark">Rules & Policies</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {cartData.houseRules.map((rule, idx) => {
                ...
                return (
                  <div 
                    key={idx} 
                    className={`bg-white border border-sand-accent/10 rounded-2xl p-6 space-y-3 shadow-sm ${
